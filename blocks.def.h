...
//	                           ☀                       ⏻                   
	{"GPU ", "cat /sys/class/drm/card0/device/gpu_busy_percent | awk '{print $0\"%\"}'", 1,  0},
	{"CPU ", "(grep 'cpu ' /proc/stat;sleep 0.1;grep 'cpu ' /proc/stat)|awk -v RS="" '{print ($13-$2+$15-$4)*100/($13-$2+$15-$4+$16-$5)}'|head -c 2 | tr -d '.'|awk '{print $0\"%\"}'", 1, 0},
